...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.cache/wt [current_project]
  set_property parent.project_path C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.xpr [current_project]
  set_property ip_output_repo C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/master/Embedded/borrar/Assignment_2/EmbeddedSystem_labs/AS03/AS03.srcs/constrs_1/imports/lab1/lab1_zybo.xdc
  set_param project.isImplRun true
